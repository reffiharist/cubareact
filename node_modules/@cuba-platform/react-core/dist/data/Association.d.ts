import { DataCollectionOptions, DataCollectionStore } from './Collection';
 ...
 */
export declare const loadAssociationOptions: <E>(parentEntityName: string, attributeName: string, nestedEntityName: string, getAttributePermission: (entityName: string, attributeName: string) => EntityAttrPermissionValue, opts?: DataCollectionOptions) => DataCollectionStore<E> | undefined;
/**
 ...
 * `undefined`.
 */
export declare const loadAllAssociationOptions: (entityProperties: MetaPropertyInfo[], entityName: string, getAttributePermission: (entityName: string, attributeName: string) => EntityAttrPermissionValue, opts?: DataCollectionOptions | undefined) => Map<string, DataCollectionStore<Partial<WithId & SerializedEntityProps>> | undefined>;
