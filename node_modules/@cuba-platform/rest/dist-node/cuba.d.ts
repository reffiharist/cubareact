import { EffectivePermsInfo, EffectivePermsLoadOptions, EntitiesWithCount, EntityMessages, EnumInfo, MetaClassInfo, SerializedEntity, UserInfo, View } from "./model";
...
export declare type CommitMode = 'create' | 'edit';
...
export declare class CubaApp {
    ...
    getEffectivePermissions(effectivePermsLoadOptions?: EffectivePermsLoadOptions, fetchOptions?: FetchOptions): Promise<EffectivePermsInfo>;
