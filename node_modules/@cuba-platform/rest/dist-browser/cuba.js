...
var CubaApp = /** @class */ (function () {
    ...
    CubaApp.prototype.commitEntity = function (entityName, entity, fetchOptions) {
        var commitMode = (fetchOptions !== null && fetchOptions !== void 0 ? fetchOptions : {}).commitMode;
    ...
    CubaApp.prototype.getEffectivePermissions = function (effectivePermsLoadOptions, fetchOptions) {
        var _this = this;
        var loadOpts = __assign({ entities: true, entityAttributes: true, specific: true }, effectivePermsLoadOptions);
        return this.requestIfSupported('7.2', function () { return _this.fetchJson('GET', 'v2/permissions/effective', loadOpts, fetchOptions); });
    };
     ...
     */
    CubaApp.prototype.fetchJson = function (method, path, data, fetchOptions) {
        return this.fetch(method, path, data, __assign({ handleAs: 'json' }, fetchOptions));
    };
...
},{"./model":2,"./security":3,"./storage":4,"./util":5}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var PredefinedView;
